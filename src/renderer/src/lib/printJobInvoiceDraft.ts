...
<body>
  <main class="invoice">
    ...
    <section class="bill">
      ...
      <div>
        <div class="value"><strong>Date:</strong> ${escapeHtml(dateLabel(snapshot.created_at))}</div>
