...
/**
 * Safety net: some installs may reference `appointments` without migration 035
 * having been applied (e.g. restored DB, failed migration). Idempotent.
 */
export function migration044(db: Database.Database): void {
  db.exec(`
